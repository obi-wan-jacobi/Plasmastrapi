define(["../../engine/Objects/EventEmitter"], function(EventEmitter) {
    ...
    Tool.prototype.equip = function () {
        this.__engine.inputSystem.addEventListener('onmousemove', this, this.__$input_mousemove);
        ...
        this.__engine.pickSystem.addEventListener('onmousemove', this, this.__$pick_mousemove);
    ...
    Tool.prototype.discard = function () {
        this.__engine.inputSystem.removeEventListener('onmousemove', this, this.__$input_mousemove);
        ...
        this.__engine.pickSystem.removeEventListener('onmousemove', this, this.__$pick_mousemove);
